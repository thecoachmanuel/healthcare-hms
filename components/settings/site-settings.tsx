 ...
 function SiteSettingsForm({ initial }: { initial: any }) {
   const [loading, setLoading] = useState(false);
   const form = useForm({ defaultValues: { site_name: initial?.site_name ?? "Healthcare HMS", logo_url: initial?.logo_url ?? "", homepage_text: initial?.homepage_text ?? "" } });
